...
class ChatRemaja extends StatefulWidget {
  const ChatRemaja({Key? key}) : super(key: key);

  @override
  State<ChatRemaja> createState() => _ChatRemajaState();
}

class _ChatRemajaState extends State<ChatRemaja> {
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                                MaterialPageRoute(
                                    builder: (context) => HomePageRemaja()));
                          },
                          child: Icon(
                            Icons.arrow_back,
                            size: 32,
